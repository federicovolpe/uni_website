CREATE TABLE studente(
    ...
    corso_frequentato CHAR(10) REFERENCES corso(nome_corso)
);

-- popolazione della tabella studente
insert into studente (matricola, nome, cognome, corso) values (986899, 'Ancell', 'Janssens', "Sicurezza Informatica");
insert into studente (matricola, nome, cognome, corso) values (103246, 'Clara', 'Poyner', "Sicurezza Informatica");
insert into studente (matricola, nome, cognome, corso) values (148008, 'Karyn', 'Claybourn', "Chimica");
insert into studente (matricola, nome, cognome, corso) values (511415, 'Harmony', 'MacClenan', "Chimica");
insert into studente (matricola, nome, cognome, corso) values (903187, 'Raine', 'Di Carli', "Chimica");
insert into studente (matricola, nome, cognome, corso) values (722630, 'Anissa', 'Guitel', "Fisica");
insert into studente (matricola, nome, cognome, corso) values (358096, 'Vernen', 'Moss', "Fisica");
insert into studente (matricola, nome, cognome, corso) values (208078, 'Annabal', 'Pamment', "Fisica");
insert into studente (matricola, nome, cognome, corso) values (147692, 'Brigit', 'Jain', "Informatica");
insert into studente (matricola, nome, cognome, corso) values (905716, 'Dena', 'Barringer', "Informatica");
insert into studente (matricola, nome, cognome, corso) values (657874, 'Willetta', 'Abrahami', "Informatica");
insert into studente (matricola, nome, cognome, corso) values (571848, 'Gardner', 'Strand', "Informatica");
insert into studente (matricola, nome, cognome, corso) values (645198, 'Worden', 'Gilhouley', "Informatica Musicale");
insert into studente (matricola, nome, cognome, corso) values (342631, 'Bibi', 'Huskinson', "Informatica Musicale");
insert into studente (matricola, nome, cognome, corso) values (596144, 'Madlin', 'Findley', "Informatica Musicale");
...
CREATE TABLE insegnamento(
    ...
    descrizione TEXT,
    anno CHAR(4),
    corso VARCHAR(100) REFERENCES corso(nome)
);
...
insert into insegnamento (id, nome, descrizione, anno, corso) values (6684943179, "Crittografia", null, 3, "Informatica Musicale");
...
CREATE TABLE esami(
    id CHAR(6) PRIMARY KEY,
    insegnamento VARCHAR(100) REFERENCES insegnamento(nome),
